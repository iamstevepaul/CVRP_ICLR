...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', default='outputs/mrta_gcapcn_real/epoch-1.pt', type=str)
    ...
    for h in dim:
        for i in n_tasks:
            data_set = "data/vrp_gaussian_100.pkl"
            # data_set = "data/X-n1001-k43.pkl"
            opts.datasets = [data_set]

            for j in Encoders:
                encoder_path = 'outputs/h_'+str(h)+'/Enc_'+str(j)+'/'
